...
class VentanaDetalleCommit(BaseModalScreen):
    ...
    #meta_section { height: auto; max-height: 8; overflow-y: auto; border-bottom: solid #333; padding: 0 0 1 0; }
    ...
    #message_label { height: auto; max-height: 4; overflow-y: auto; color: #ffaf00; padding: 1 0; border-bottom: solid #333; }
